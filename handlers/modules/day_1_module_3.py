...
class Day1Module3States(StatesGroup):
    ...
    step_10 = State()  # Завершение
    step_11 = State()  # Медитация
...
# Шаг 1 -> Шаг 2
@router.message(Day1Module3States.step_1, F.text == "💡 Понимать тревогу важно")
...
# Шаг 2 -> Шаг 3
@router.message(Day1Module3States.step_2, F.text == "⚡ Тревога — это вспышки")
...
# Шаг 3 -> Шаг 4
@router.message(Day1Module3States.step_3, F.text == "🪞 Зеркало для тревоги")
...
# Шаг 4 -> Шаг 5
@router.message(Day1Module3States.step_4, F.text == "👀 Замечать тревогу раньше")
...
# Шаг 5 -> Шаг 6
@router.message(Day1Module3States.step_5, F.text == "🕊️ Больше свободы")
...
# Шаг 6 -> Шаг 7 (принимаем любой текст или голосовое)
@router.message(Day1Module3States.step_6, F.text == "✅ Готово")
@router.message(Day1Module3States.step_6, F.text)
@router.message(Day1Module3States.step_6, F.voice)
async def step_6_to_7(message: Message, state: FSMContext):
    ...
    await message.answer(
        "🌬️ Давай снова вернёмся к нашей практике дыхания.\n"
        "Вспомни: вдох на 4 секунды ⏱️, выдох на 6.\n"
        "Подыши так пару минут — этого достаточно, чтобы тело стало спокойнее 😌",
        reply_markup=get_step_keyboard(7)
    )

# Шаг 7 -> Шаг 8
@router.message(Day1Module3States.step_7, F.text == "🌿 Стало легче")
...
async def step_10_to_11(message: Message, state: FSMContext):
    ...
    await state.set_state(Day1Module3States.step_11)
...
@router.message(Day1Module3States.step_11, F.text == "🏠 В основное меню")
