    ...
    if not bookmark or not bookmark['current_course_id']:
        ...
        await message.answer_video(
            ...
            caption="👋 <b>Привет!</b>\n\n"
                    ...
                    "📚 <b>Здесь нет скучных лекций.</b>\n"
                    "Вместе с профессиональными психологами мы создали:\n\n"
                    "• <b>Чёткую и ёмкую теорию</b> — только то, что действительно работает\n"
                    "• <b>Интерактивные форматы</b>, которые вовлекают, а не усыпляют\n"
                    "• <b>Научно обоснованные практики</b> для реальных ситуаций современной жизни\n\n"
                    "💡 <b>Каждая практика</b> — это конкретный шаг к спокойствию, фокусу и внутренней опоре.\n\n"
                    "✨ <b>Давай познакомимся ближе?</b>\n"
