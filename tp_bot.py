...
from handlers.modules import day_1_module_1, day_1_module_2, day_1_module_3, day_2_module_1, day_2_module_2, day_2_module_3
...
async def main():
    ...
    dp.include_router(day_2_module_2.router)
    dp.include_router(day_2_module_3.router)
